...
def CreateViewBranch(dimensions, startInputs, endInputs):
    ...
    startBranch = Conv2D(filters=16, kernel_size=3, activation="relu", padding="same")(startBranch)
    ...
    endBranch = Conv2D(filters=16, kernel_size=3, activation="relu", padding="same")(endBranch)
